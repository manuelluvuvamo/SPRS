...
class UserController extends Controller
{
       ...
       // dd($request);
        ...
        try {
            ...
            if ($request->hasFile('profile_photo_path') && $request->file('profile_photo_path')->isValid()) {
                ...
                $this->loggerData(" Editou o utilizador  de id, nome, gênero, email, nível, telefone ($u->id, $u->name, $u->genero, $u->email, $u->level, $u->phone_number) para ($request->name, $request->genero, $request->email, $request->level, $request->phone_number)");
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $this->loggerData(" Eliminou o utilizador  de id, nome, gênero, email, nível, telefone ($user->id, $user->name, $user->genero, $user->email, $user->level, $user->phone_number)");
    ...
    public function purge($id)
    {
        ...
        try {
            ...
            $this->loggerData(" Purgou o utilizador  de id, nome, gênero, email, nível, telefone ($user->id, $user->name, $user->genero, $user->email, $user->level, $user->phone_number)");
