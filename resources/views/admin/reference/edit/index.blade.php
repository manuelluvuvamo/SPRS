...
@section('titulo', 'Edição de Referências')
@section('conteudo')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Referência</h6>
    ...
    {{-- reference --}}
    @if (session('reference.update.success'))
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Referência Editada Com Sucesso!',
                timer: 4e3,
                timerProgressBar: !0,
                didOpen: function() {
    ...
    @if (session('reference.update.error'))
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Erro ao Editar Referência!',
                timer: 4e3,
                timerProgressBar: !0,
                didOpen: function() {
                    Swal.showLoading(), t = setInterval(function() {
